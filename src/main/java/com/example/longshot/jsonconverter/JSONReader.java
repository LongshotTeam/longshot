...
public class JSONReader {
    ...
    public AddQueryReponse addSerchTermInSolr(String searchTerm) throws IOException {
        ...
        if (searchTerm != null)
            searchRes = objectMapper.readValue(new File("/resources/json/searchTermResponse.json"),
    ...
    public SearchServiceDTO readJsonWithObjectMapperDemo(SearchQuery query) throws IOException {
        ...
        if (query.getResponsetype() == null || query.getResponsetype().equals("")) {
            if (query.getKeyword().equalsIgnoreCase("milk"))
                searchRes = objectMapper.readValue(new File("/resources/json/milk_Default.json"),
                        SearchServiceDTO.class);
            else if (query.getKeyword().equalsIgnoreCase("bread"))
                searchRes = objectMapper.readValue(new File("/resources/json/bread_Default.json"),
                        SearchServiceDTO.class);
            else if (query.getKeyword().equalsIgnoreCase("tomoto"))
                searchRes = objectMapper.readValue(new File("/resources/json/tomoto_Default.json"),
                        SearchServiceDTO.class);
            else if (query.getKeyword().equalsIgnoreCase("banana"))
                searchRes = objectMapper.readValue(new File("/resources/json/banana_Default.json"),
                        SearchServiceDTO.class);
        }
        ...
        //Clickstream_Constant_Threshold
            ...
            searchRes = objectMapper.readValue(new File("/resources/json/milk_algo1.json"), SearchServiceDTO.class);
        else if (query.getKeyword().equalsIgnoreCase("bread") && query.getResponsetype().equalsIgnoreCase("algo1"))
            searchRes = objectMapper.readValue(new File("/resources/json/bread_algo1.json"),
                    SearchServiceDTO.class);
        else if (query.getKeyword().equalsIgnoreCase("tomoto") && query.getResponsetype().equalsIgnoreCase("algo1")) {
            searchRes = objectMapper.readValue(new File("/resources/json/tomoto_algo1.json"), SearchServiceDTO.class);
        }
        else if (query.getKeyword().equalsIgnoreCase("banana") && query.getResponsetype().equalsIgnoreCase("algo1")) {
            searchRes = objectMapper.readValue(new File("/resources/json/banana_algo1.json"), SearchServiceDTO.class);
        }
      ...
      //Clickstream Relative  Threshold
            ...
            searchRes = objectMapper.readValue(new File("/resources/json/banana_algo2.json"),
                    SearchServiceDTO.class);
        }
        else if (query.getKeyword().equalsIgnoreCase("bread") && query.getResponsetype().equalsIgnoreCase("algo2")) {
            searchRes = objectMapper.readValue(new File("/resources/json/bread_algo2.json"),
                    SearchServiceDTO.class);
        }
        else if (query.getKeyword().equalsIgnoreCase("tomoto") && query.getResponsetype().equalsIgnoreCase("algo2")) {
            searchRes = objectMapper.readValue(new File("/resources/json/tomoto_algo2.json"),
                    SearchServiceDTO.class);
        }
        else if (query.getKeyword().equalsIgnoreCase("milk") && query.getResponsetype().equalsIgnoreCase("algo2")) {
            searchRes = objectMapper.readValue(new File("/resources/json/milk_algo2.json"),
                    SearchServiceDTO.class);
        ...
        //Merchadizing Boost Bury Rules
            ...
            searchRes = objectMapper.readValue(new File("/resources/json/bread_Boost.json"),
                    SearchServiceDTO.class);
        } else if (query.getKeyword().equalsIgnoreCase("banana") && query.getResponsetype().equalsIgnoreCase("assembler")) {
            searchRes = objectMapper.readValue(new File("/resources/json/banana_Boost.json"), SearchServiceDTO.class);
        }
        else if (query.getKeyword().equalsIgnoreCase("tomoto") && query.getResponsetype().equalsIgnoreCase("assembler")) {
            searchRes = objectMapper.readValue(new File("/resources/json/tomoto_Boost.json"), SearchServiceDTO.class);
        }else if (query.getKeyword().equalsIgnoreCase("milk") && query.getResponsetype().equalsIgnoreCase("assembler")) {
            searchRes = objectMapper.readValue(new File("/resources/json/milk_Boost.json"), SearchServiceDTO.class);
        }
